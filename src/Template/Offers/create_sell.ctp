...
if (!Configure::read('debug')):
    throw new NotFoundException('Please replace src/Template/Offers/create_sell.ctp with your own version.');
endif;
?>
...
<div class="main-content">
    <div class="container">
        ...
        <div class="dashboard-content">
            <h1>TÔI MUỐN BÁN WEX (USD)</h1>
            <form class="form" id="frmCreateOfferSell" action="<?=$this->Url->build(['controller' => 'Offers', 'action' => 'createSell'])?>" method="post">
                <fieldset>
                    <legend>GIÁ BÁN</legend>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6">
                                <label class="col-sm-6" for="price">Giá bạn thực nhận</label>
                                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6">
                                <label class="col-sm-6" for="price_view">Giá người mua thấy</label>
                                <div class="col-sm-6">
                                    <div class="input-group">
                            ...
                            <div class="col-sm-6">
                                <div class="description mt5">Giá đã bao gồm phí giao dịch do người mua chịu.</div>
                            </div>
                        </div>
                    </div>
                </fieldset>
