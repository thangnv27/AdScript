...
if (!Configure::read('debug')):
    throw new NotFoundException('Please replace src/Template/Ads/edit.ctp with your own version.');
endif;
?>
            ...
            <div class="panel panel-info mb0">
                ...
                <div class="panel-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="title" name="title" value="" class="form-control" placeholder="eg: 728x90" />
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <p><input type="text" id="image_url" name="image_url" value="" class="form-control" placeholder="https://i.imgur.com/ram51Wy.jpg" /></p>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="target_url" name="target_url" value="" class="form-control" placeholder="https://your_domain.com/page-link" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3" for="utm_params">UTM Parameters</label>
                        <div class="col-sm-9">
                            <p><input type="text" id="utm_params" name="utm_params" value="" class="form-control" placeholder="utm_campaign=name&utm_source=adscript.net&utm_medium=banner&utm_term=keyword&utm_content=website" /></p>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <label for="status_0" class="normal">
                                <input type="radio" id="status_0" name="status" value="0" /> Inactive
                            </label>
                        </div>
                    </div>
                </div>
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-9 col-sm-offset-3">
                            <button class="btn btn-primary btn-lg btn-submit">ADD NEW</button>
                        </div>
                    </div>
                </div>
            </div>
