...
//                parent.tinymce.activeEditor.windowManager.windows[0].find('#src').fire('change');
                // close popup window
	...
	var // jQuery and jQueryUI version
		...
		opts = {
			...
			lang: lang,                        // auto detected language (optional)
                        height: parent.fileDialogHeight - 20,
                        getFileCallback: function(file) {  // editor callback
                            // actually file.url - doesnt work for me, but file does
